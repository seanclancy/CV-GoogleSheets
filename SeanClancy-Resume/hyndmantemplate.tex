...
\documentclass[letterpaper]{article}\documentclass[$if(fontsize)$$fontsize$$else$10pt$endif$,$if(lang)$$babel-lang$,$endif$$if(papersize)$$papersize$$else$a4paper$endif$,$for(classoption)$$classoption$$sep$,$endfor$]{article}
$if(fontfamily)$
...
%\titlespacing{\section}{0pt}{-\parskip*2}{0pt}
...
\titlespacing{\subsubsection}{0pt}{1mm}{0mm}
...
\newcommand{\CSLRightInline}[1]{\parbox[t]{\linewidth - \cslhangindent - \csllabelwidth}{#1}\vspace{0.4ex}}
